...
class KnowledgeSearchServiceTest {
  ...
  @DisplayName("KnowledgeListRepository 에서 예외가 발생한 경우 KnowledgeException을 예외로 던진다.")
  @Test
  void shouldThrowKnowledgeException_WhenRepositoryThrowsDataAccessException(){
    //given
    given(knowledgeSearchRepository.findByTitleContaining(any(), anyString()))
            .willThrow(new DataAccessException("의도적 예외") {});

    //when & then
    assertThatThrownBy(() -> knowledgeSearchService.searchKnowledgeByTitle(SEARCH_TITLE))
