...
public class KnowledgeQuizController {
    ...
    public ResponseEntity<Void> registerKnowledgeAndQuiz(@Valid @RequestBody KnowledgeRegisterRequestDto knowledgeRegisterRequestDto) {
        knowledgeQuizService.registerKnowledgeAndQuiz(knowledgeRegisterRequestDto);
